...
import defaultKit from '../../Kits/helpers/defaultKit.js';
import defaultSettlement from '../../Kits/helpers/defaultSettlement.js';
import toolChoices from '../../Kits/helpers/toolChoices.js';
import mergeKit from '../../Kits/helpers/mergeObjects.js';
...
const SidePanelKit = ({}) => {
  ...
  return (
    <Box sx={{ height: '100%', overflowY: 'scroll', mt: 1 }}>
      <ButtonGroup
        variant="outlined"
