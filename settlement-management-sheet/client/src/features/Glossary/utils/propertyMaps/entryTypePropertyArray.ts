...
const regionPropertyArrayMap = definePropertyArrayMap<keyof TerritoryEntry>([
  {
    name: 'Geography',
    children: [
      {
...
const nationPropertyArrayMap = definePropertyArrayMap<keyof DomainEntry>([
  {
    name: 'Government',
    children: [
      {
...
const territoryPropertyArrayMap = definePropertyArrayMap<keyof ProvinceEntry>([
  {
    name: 'Geography',
    children: [
      {
...
const collectivePropertyArrayMap = definePropertyArrayMap<keyof FactionEntry>([
  {
    name: 'Roster',
    children: [
      {
...
const lorePropertyArrayMap = definePropertyArrayMap<keyof NoteEntry>([
  {
    name: 'Details',
    children: [
      {
...
type GlossaryEntryMap = {
  ...
  region: TerritoryEntry;
  nation: DomainEntry;
  territory: ProvinceEntry;
  landmark: LandmarkEntry;
  settlement: SettlementEntry;
  collective: FactionEntry;
  person: PersonEntry;
