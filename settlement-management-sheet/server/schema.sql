-- CreateEnum
CREATE TYPE "ContentTypes" AS ENUM ('SYSTEM', 'CUSTOM');
...
-- CreateEnum
CREATE TYPE "EntryTypes" AS ENUM ('continent', 'region', 'nation', 'territory', 'landmark', 'settlement', 'district', 'collective', 'location', 'person', 'lore', 'item', 'event', 'folder');
...
-- CreateEnum
CREATE TYPE "PropertyInputTypes" AS ENUM ('text', 'date', 'range', 'checkbox', 'dropdown', 'compound');

-- CreateEnum
CREATE TYPE "BacklinkType" AS ENUM ('direct', 'directCompound', 'indirect', 'hierarchal');
...
CREATE TABLE "GlossaryEntry" (
    ...
    "name" TEXT,
    "groups" JSONB,
    "primaryAnchorId" TEXT,
    "primaryAnchorValue" JSONB,
    "secondaryAnchorId" TEXT,
    "secondaryAnchorValue" JSONB,
    "tags" TEXT[],
    "integrationState" JSONB,
...
CREATE TABLE "BacklinkIndex" (
    ...
    "propertyValue" JSONB,
    "ignoreDivergence" BOOLEAN NOT NULL DEFAULT false,
    "lastSyncedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "fromNameAtLink" TEXT,
    "toNameAtLink" TEXT,
    "targetIgnore" BOOLEAN NOT NULL DEFAULT false,
    "subPropertyId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
