...
import CustomEvent from '../Events/Create/CustomEvent';
...
const CustomCreation = () => {
  ...
  return (
    <div className="flex flex-col h-screen justify-top items-center">
      <div className="sticky top-0 bg-[#242424] z-10 pb-4 w-full">
        <h1 className="text-3xl font-bold mb-4 text-center mt-4 ">
          Eclorean Ledger Creation Tool
        </h1>
        <div className="grid grid-cols-3 gap-4 justify-around px-4">
